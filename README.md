...
- **매출 트렌드 분석:** Olist의 과거(2016.09 ~ 2018.08) 매출 패턴을 전체 국가 수준과 26개 주별로 평가하여 매출액, 주문량, 평균 주문 금액(AOV)에 집중한 분석을 수행. 시간에 따른 GMV 변동을 보면 계절성, 소비 트렌드, 경제적 요인 등이 플랫폼에 미치는 영향을 파악가능. 이는 Olist가 미래 전략을 세우는 데 유용한 인사이트를 제공. 
