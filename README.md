# 프로젝트 개요
Olist는 2015년 7월에 설립된 브라질의 이커머스 기업으로, 중소기업들이 여러 온라인 마켓플레이스에서 제품을 판매할 수 있도록 지원하는 중개 플랫폼을 제공합니다. 본 프로젝트는 Olist의 매출액, 주문 수, 제품 라인업 등 방대한 데이터셋을 종합 및 분석하여, Olist의 시장 경쟁력을 강화할 인사이트를 도출하는 것을 목표로 진행되었으며 다음 2가지 핵심 영역에 대한 분석 결과와 전략적 제안을 제시합니다:
