...
- **제품라인별 성과 분석:** 71개의 제품 라인을 유사한 특성에 따라 15개의 제품군으로 재분류하여 각 제품군이 전체 매출에 미치는 영향을 파악하고 어떤 카테고리가 매출을 주도하는지 파악함으로써 판매자들에게 효과적인 판매 전략과 가이드라인을 제공.
<br>  
...
<br><br>               
<img width="1200" alt="image" src="https://github.com/user-attachments/assets/0741578e-567d-418d-9151-9a8a9d92ef90" />
<br><br>
<img width="400" alt="image" src="https://github.com/user-attachments/assets/2e4fd467-f483-47d2-9d51-229890986ef8" />
...
특히 **2017년 11월**에는 전월 대비 **49%의 MoM 성장률**을 기록하며 최대 매출 증가율을 보였으나, 2018년에는 상승과 하락이 반복되는 변동성이 더 증가했습니다. 예를 들어, **2018년 6월(-14%)과 7월(-6%)** 에는 연속적인 매출 감소가 발생했습니다.  
한편, 평균 주문문 금액(AOV)은 전월 대비 **±10% 범위 내에서 안정적**이었으며, 예측 모델에 따르면 향후 **$135 수준**을 유지할 것으로 예상됩니다. <br>     
다음 섹션에서는 2016년 말 매출이 바닥이었던 이유와 2018년 성장세가 느슨해진 원인(경제 환경, 경쟁사 영향 등)을 심층 분석하고, 운영 효율성 제고를 위한 전략을 제시합니다.<br>  
...
* **지역별 성과**
  * **상파울루**는 매출액, 주문수에서 두드러지게 가장 큰 성과를 보이지만 평균 주문 금액을 보면 **$125**로 마지막 순위이며 전체 평균 구매 금액인 **$137**보다 적음.
    * 상파울루는 브라질의 경제 중심지로 가장 많은 인구를 보유(약 4600만명)하고 있으며 높은 소비력을 갖춘 대도시.
  * **파라이바**는 매출액, 주문수에서 26개의 지역들 중 17위를 차지하지만 평균 주문 금액은 $215로 1순위.
    * 파라이바는 관광 산업이 발달한 지역으로 인구는 약 400만명 밖에 되지 않지만 고가의 상품을 구매하는 경향이 있음 **(평균가격이 $128인 전자제품/가전이 15개의 제품군 중 1위)** 
<img width="900" alt="image" src="https://github.com/user-attachments/assets/35473326-564e-4eb9-b259-7ddf7f8dcdfe" />
<br>
...
* **이커머스에서 소비자들은 생필품보다 미용, 패션, 악세서리, 스포츠/레저 제품군에 더 많은 지출을 하는 경향을 보임**
  * 매출액 2위 제품군은 미용/건강, 3위는 패션/악세서리.
  * 패션/악세서리 제품군 내 1위 카테고리는 시계/선물
...
* **매출액 상위 10%(~7위)에 랭킹된 카테고리 대부분 2017년 11월 정점을 찍고 매출액이 감소하는 추세** 
...
* 스포츠/레저, 컴퓨터/악세서리 카테고리는 모두 매출액 5위안에 드는 제품라인들로 전체 매출의 7~9%를 차지하지만 2017년 말 이후 꾸준히 매출액이 감소하는 추세. 이 제품라인들에 대해 프로모션 행사 적용.
...
* **Olist의 영업이익 산출 한계**: Olist의 비즈니스 모델은 판매자에게 플랫폼 수수료를 징수함으로써 수익이 발생하는 구조.
  GMV는 Olist의 직접적인 매출은 아니지만 플랫폼의 규모와 성장성을 보여주는 핵심 지표 (높은 GMV는 Olist가 많은 거래를 중개하고 있으며, 시장에서 경쟁력을 갖추고 있다는 뜻)이며 투자자나 내부 경영진이 Olist의 성과를 평가할 때 중요한 기준.     
